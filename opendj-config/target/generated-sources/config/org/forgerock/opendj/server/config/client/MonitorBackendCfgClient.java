 ...
 */
public interface MonitorBackendCfgClient extends LocalBackendCfgClient {

  /**
   * Get the configuration definition associated with this Monitor Backend.
   *
   * @return Returns the configuration definition associated with this Monitor Backend.
   */
