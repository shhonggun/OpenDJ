...
public interface EntityTagVirtualAttributeCfgClient extends VirtualAttributeCfgClient {
   ...
   *
   * @return Returns the configuration definition associated with this Entity Tag Virtual Attribute.
   */
   ...
   * checksum value.
   *
   * @param value The value of the "checksum-algorithm" property.
   * @throws PropertyException
   *           If the new value is invalid.
   */
  void setChecksumAlgorithm(ChecksumAlgorithm value) throws PropertyException;
   ...
   * the checksum.
   *
   * @return Returns the values of the "excluded-attribute" property.
   */
   ...
   * the checksum.
   *
   * @param values The values of the "excluded-attribute" property.
   * @throws PropertyException
