 ...
 */
public interface SaltedSHA256PasswordStorageSchemeCfgClient extends PasswordStorageSchemeCfgClient {

  /**
   * Get the configuration definition associated with this Salted SHA256 Password Storage Scheme.
   *
   * @return Returns the configuration definition associated with this Salted SHA256 Password Storage Scheme.
   */
