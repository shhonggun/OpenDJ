...
import org.forgerock.opendj.server.config.client.StructuralObjectClassVirtualAttributeCfgClient;
 ...
 * RFC 4512.
 */
public final class StructuralObjectClassVirtualAttributeCfgDefn extends ManagedObjectDefinition<StructuralObjectClassVirtualAttributeCfgClient, StructuralObjectClassVirtualAttributeCfg> {

  /** The singleton configuration definition instance. */
  private static final StructuralObjectClassVirtualAttributeCfgDefn INSTANCE = new StructuralObjectClassVirtualAttributeCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<AttributeType> provider = new DefinedDefaultBehaviorProvider<AttributeType>("structuralObjectClass");
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.StructuralObjectClassVirtualAttributeProvider");
      builder.setDefaultBehaviorProvider(provider);
   ...
   *
   * @return Returns the Structural Object Class Virtual Attribute
   ...
   * Private constructor.
   */
  private StructuralObjectClassVirtualAttributeCfgDefn() {
    super("structural-object-class-virtual-attribute", VirtualAttributeCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public StructuralObjectClassVirtualAttributeCfgClient createClientConfiguration(
      ManagedObject<? extends StructuralObjectClassVirtualAttributeCfgClient> impl) {
    return new StructuralObjectClassVirtualAttributeCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public StructuralObjectClassVirtualAttributeCfg createServerConfiguration(
      ServerManagedObject<? extends StructuralObjectClassVirtualAttributeCfg> impl) {
    return new StructuralObjectClassVirtualAttributeCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<StructuralObjectClassVirtualAttributeCfg> getServerConfigurationClass() {
    return StructuralObjectClassVirtualAttributeCfg.class;
  }
   ...
   * <p>
   * Indicates whether the Structural Object Class Virtual Attribute
   * is enabled for use.
   *
   ...
   */
  private static class StructuralObjectClassVirtualAttributeCfgClientImpl implements
    StructuralObjectClassVirtualAttributeCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends StructuralObjectClassVirtualAttributeCfgClient> impl;



    /** Private constructor. */
    private StructuralObjectClassVirtualAttributeCfgClientImpl(
        ManagedObject<? extends StructuralObjectClassVirtualAttributeCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends StructuralObjectClassVirtualAttributeCfgClient, ? extends StructuralObjectClassVirtualAttributeCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class StructuralObjectClassVirtualAttributeCfgServerImpl implements
    StructuralObjectClassVirtualAttributeCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends StructuralObjectClassVirtualAttributeCfg> impl;
    ...
    /** Private constructor. */
    private StructuralObjectClassVirtualAttributeCfgServerImpl(ServerManagedObject<? extends StructuralObjectClassVirtualAttributeCfg> impl) {
      this.impl = impl;
    ...
    /** {@inheritDoc} */
    public void addStructuralObjectClassChangeListener(
        ConfigurationChangeListener<StructuralObjectClassVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removeStructuralObjectClassChangeListener(
        ConfigurationChangeListener<StructuralObjectClassVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends StructuralObjectClassVirtualAttributeCfg> configurationClass() {
      return StructuralObjectClassVirtualAttributeCfg.class;
    }
