...
public interface FileBasedErrorLogPublisherCfg extends ErrorLogPublisherCfg {
   ...
   *
   * @return Returns the configuration class associated with this File Based Error Log Publisher.
   */
   ...
   *
   * @param listener
   *          The File Based Error Log Publisher configuration change listener.
   */
   ...
   *          The File Based Error Log Publisher configuration change listener.
   */
  void removeFileBasedErrorChangeListener(ConfigurationChangeListener<FileBasedErrorLogPublisherCfg> listener);
