...
public interface CsvFileHTTPAccessLogPublisherCfg extends HTTPAccessLogPublisherCfg {
   ...
   *
   * @return Returns the configuration class associated with this Csv File HTTP Access Log Publisher.
   */
   ...
   *
   * @param listener
   *          The Csv File HTTP Access Log Publisher configuration change listener.
   */
   ...
   *          The Csv File HTTP Access Log Publisher configuration change listener.
   */
  void removeCsvFileHTTPAccessChangeListener(ConfigurationChangeListener<CsvFileHTTPAccessLogPublisherCfg> listener);
