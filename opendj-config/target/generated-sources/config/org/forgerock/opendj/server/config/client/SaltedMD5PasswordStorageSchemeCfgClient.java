 ...
 * digest algorithm.
 */
public interface SaltedMD5PasswordStorageSchemeCfgClient extends PasswordStorageSchemeCfgClient {

  /**
   * Get the configuration definition associated with this Salted MD5 Password Storage Scheme.
   *
   * @return Returns the configuration definition associated with this Salted MD5 Password Storage Scheme.
   */
  ManagedObjectDefinition<? extends SaltedMD5PasswordStorageSchemeCfgClient, ? extends SaltedMD5PasswordStorageSchemeCfg> definition();
