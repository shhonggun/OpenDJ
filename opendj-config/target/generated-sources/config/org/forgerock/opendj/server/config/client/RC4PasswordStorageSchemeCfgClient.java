 ...
 */
public interface RC4PasswordStorageSchemeCfgClient extends PasswordStorageSchemeCfgClient {

  /**
   * Get the configuration definition associated with this RC4 Password Storage Scheme.
   *
   * @return Returns the configuration definition associated with this RC4 Password Storage Scheme.
   */
  ManagedObjectDefinition<? extends RC4PasswordStorageSchemeCfgClient, ? extends RC4PasswordStorageSchemeCfg> definition();
