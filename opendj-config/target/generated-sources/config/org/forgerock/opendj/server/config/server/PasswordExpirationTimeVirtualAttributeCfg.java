 ...
 */
public interface PasswordExpirationTimeVirtualAttributeCfg extends VirtualAttributeCfg {

  /**
   * Gets the configuration class associated with this Password Expiration Time Virtual Attribute.
   *
   * @return Returns the configuration class associated with this Password Expiration Time Virtual Attribute.
   */
  Class<? extends PasswordExpirationTimeVirtualAttributeCfg> configurationClass();
   ...
   *
   * @param listener
   *          The Password Expiration Time Virtual Attribute configuration change listener.
   */
  void addPasswordExpirationTimeChangeListener(ConfigurationChangeListener<PasswordExpirationTimeVirtualAttributeCfg> listener);
   ...
   *          The Password Expiration Time Virtual Attribute configuration change listener.
   */
  void removePasswordExpirationTimeChangeListener(ConfigurationChangeListener<PasswordExpirationTimeVirtualAttributeCfg> listener);
