 ...
 */
public interface MemoryBackendCfg extends LocalBackendCfg {

  /**
   * Gets the configuration class associated with this Memory Backend.
   *
   * @return Returns the configuration class associated with this Memory Backend.
   */
   ...
   *
   * @param listener
   *          The Memory Backend configuration change listener.
   */
