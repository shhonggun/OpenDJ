 ...
 */
public interface VersionMonitorProviderCfgClient extends MonitorProviderCfgClient {

  /**
   * Get the configuration definition associated with this Version Monitor Provider.
   *
   * @return Returns the configuration definition associated with this Version Monitor Provider.
   */
  ManagedObjectDefinition<? extends VersionMonitorProviderCfgClient, ? extends VersionMonitorProviderCfg> definition();
