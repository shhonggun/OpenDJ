...
public interface Base64PasswordStorageSchemeCfg extends PasswordStorageSchemeCfg {
   ...
   *
   * @return Returns the configuration class associated with this Base64 Password Storage Scheme.
   */
  Class<? extends Base64PasswordStorageSchemeCfg> configurationClass();
   ...
   *
   * @param listener
   *          The Base64 Password Storage Scheme configuration change listener.
   */
  void addBase64ChangeListener(ConfigurationChangeListener<Base64PasswordStorageSchemeCfg> listener);
   ...
   *          The Base64 Password Storage Scheme configuration change listener.
   */
  void removeBase64ChangeListener(ConfigurationChangeListener<Base64PasswordStorageSchemeCfg> listener);
