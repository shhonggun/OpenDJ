...
public interface HasSubordinatesVirtualAttributeCfg extends VirtualAttributeCfg {
   ...
   *
   * @return Returns the configuration class associated with this Has Subordinates Virtual Attribute.
   */
  Class<? extends HasSubordinatesVirtualAttributeCfg> configurationClass();
   ...
   *
   * @param listener
   *          The Has Subordinates Virtual Attribute configuration change listener.
   */
  void addHasSubordinatesChangeListener(ConfigurationChangeListener<HasSubordinatesVirtualAttributeCfg> listener);
   ...
   *          The Has Subordinates Virtual Attribute configuration change listener.
   */
  void removeHasSubordinatesChangeListener(ConfigurationChangeListener<HasSubordinatesVirtualAttributeCfg> listener);
