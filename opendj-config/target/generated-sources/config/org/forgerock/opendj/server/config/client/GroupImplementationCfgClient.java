 ...
 */
public interface GroupImplementationCfgClient extends ConfigurationClient {

  /**
   * Get the configuration definition associated with this Group Implementation.
   *
   * @return Returns the configuration definition associated with this Group Implementation.
   */
  ManagedObjectDefinition<? extends GroupImplementationCfgClient, ? extends GroupImplementationCfg> definition();
