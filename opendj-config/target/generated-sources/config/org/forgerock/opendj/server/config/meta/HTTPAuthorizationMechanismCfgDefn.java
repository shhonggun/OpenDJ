...
public final class HTTPAuthorizationMechanismCfgDefn extends AbstractManagedObjectDefinition<HTTPAuthorizationMechanismCfgClient, HTTPAuthorizationMechanismCfg> {
  ...
  private static final HTTPAuthorizationMechanismCfgDefn INSTANCE = new HTTPAuthorizationMechanismCfgDefn();
   ...
   * singleton.
   *
   * @return Returns the HTTP Authorization Mechanism configuration
   ...
   * Private constructor.
   */
  private HTTPAuthorizationMechanismCfgDefn() {
    super("http-authorization-mechanism", TopCfgDefn.getInstance());
  }
