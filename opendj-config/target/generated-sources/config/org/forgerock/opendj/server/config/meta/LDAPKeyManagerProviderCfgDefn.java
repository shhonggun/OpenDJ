...
import org.forgerock.opendj.server.config.client.LDAPKeyManagerProviderCfgClient;
...
public final class LDAPKeyManagerProviderCfgDefn extends ManagedObjectDefinition<LDAPKeyManagerProviderCfgClient, LDAPKeyManagerProviderCfg> {
  ...
  private static final LDAPKeyManagerProviderCfgDefn INSTANCE = new LDAPKeyManagerProviderCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.LDAPKeyManagerProvider");
   ...
   * singleton.
   *
   * @return Returns the LDAP Key Manager Provider configuration
   ...
   * Private constructor.
   */
  private LDAPKeyManagerProviderCfgDefn() {
    super("ldap-key-manager-provider", KeyManagerProviderCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public LDAPKeyManagerProviderCfgClient createClientConfiguration(
      ManagedObject<? extends LDAPKeyManagerProviderCfgClient> impl) {
    return new LDAPKeyManagerProviderCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public LDAPKeyManagerProviderCfg createServerConfiguration(
      ServerManagedObject<? extends LDAPKeyManagerProviderCfg> impl) {
    return new LDAPKeyManagerProviderCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<LDAPKeyManagerProviderCfg> getServerConfigurationClass() {
    return LDAPKeyManagerProviderCfg.class;
  }
   ...
   * <p>
   * Indicates whether the LDAP Key Manager Provider is enabled for
   * use.
   *
   ...
   */
  private static class LDAPKeyManagerProviderCfgClientImpl implements
    LDAPKeyManagerProviderCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends LDAPKeyManagerProviderCfgClient> impl;



    /** Private constructor. */
    private LDAPKeyManagerProviderCfgClientImpl(
        ManagedObject<? extends LDAPKeyManagerProviderCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends LDAPKeyManagerProviderCfgClient, ? extends LDAPKeyManagerProviderCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class LDAPKeyManagerProviderCfgServerImpl implements
    LDAPKeyManagerProviderCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends LDAPKeyManagerProviderCfg> impl;
    ...
    /** Private constructor. */
    private LDAPKeyManagerProviderCfgServerImpl(ServerManagedObject<? extends LDAPKeyManagerProviderCfg> impl) {
      this.impl = impl;
    ...
    public void addLDAPChangeListener(
        ConfigurationChangeListener<LDAPKeyManagerProviderCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends LDAPKeyManagerProviderCfg> configurationClass() {
      return LDAPKeyManagerProviderCfg.class;
    }
