 ...
 * digest algorithm.
 */
public interface PKCS5S2PasswordStorageSchemeCfgClient extends PasswordStorageSchemeCfgClient {

  /**
   * Get the configuration definition associated with this PKCS5S2 Password Storage Scheme.
   *
   * @return Returns the configuration definition associated with this PKCS5S2 Password Storage Scheme.
   */
  ManagedObjectDefinition<? extends PKCS5S2PasswordStorageSchemeCfgClient, ? extends PKCS5S2PasswordStorageSchemeCfg> definition();
