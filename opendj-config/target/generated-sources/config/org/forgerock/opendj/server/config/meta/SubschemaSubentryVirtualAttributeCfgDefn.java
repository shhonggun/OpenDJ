...
import org.forgerock.opendj.server.config.client.SubschemaSubentryVirtualAttributeCfgClient;
 ...
 * <p>
 * The Subschema Subentry Virtual Attribute generates a virtual
 * attribute that specifies the location of the subschemaSubentry with
 * the schema definitions in effect for the entry. This attribute is
 * defined in RFC 4512.
 */
public final class SubschemaSubentryVirtualAttributeCfgDefn extends ManagedObjectDefinition<SubschemaSubentryVirtualAttributeCfgClient, SubschemaSubentryVirtualAttributeCfg> {

  /** The singleton configuration definition instance. */
  private static final SubschemaSubentryVirtualAttributeCfgDefn INSTANCE = new SubschemaSubentryVirtualAttributeCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<AttributeType> provider = new DefinedDefaultBehaviorProvider<AttributeType>("subschemaSubentry");
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.SubschemaSubentryVirtualAttributeProvider");
      builder.setDefaultBehaviorProvider(provider);
   ...
   *
   * @return Returns the Subschema Subentry Virtual Attribute
   *         configuration definition singleton.
   */
  public static SubschemaSubentryVirtualAttributeCfgDefn getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private SubschemaSubentryVirtualAttributeCfgDefn() {
    super("subschema-subentry-virtual-attribute", VirtualAttributeCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public SubschemaSubentryVirtualAttributeCfgClient createClientConfiguration(
      ManagedObject<? extends SubschemaSubentryVirtualAttributeCfgClient> impl) {
    return new SubschemaSubentryVirtualAttributeCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public SubschemaSubentryVirtualAttributeCfg createServerConfiguration(
      ServerManagedObject<? extends SubschemaSubentryVirtualAttributeCfg> impl) {
    return new SubschemaSubentryVirtualAttributeCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<SubschemaSubentryVirtualAttributeCfg> getServerConfigurationClass() {
    return SubschemaSubentryVirtualAttributeCfg.class;
  }
   ...
   * <p>
   * Indicates whether the Subschema Subentry Virtual Attribute is
   * enabled for use.
   *
   ...
   */
  private static class SubschemaSubentryVirtualAttributeCfgClientImpl implements
    SubschemaSubentryVirtualAttributeCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends SubschemaSubentryVirtualAttributeCfgClient> impl;



    /** Private constructor. */
    private SubschemaSubentryVirtualAttributeCfgClientImpl(
        ManagedObject<? extends SubschemaSubentryVirtualAttributeCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends SubschemaSubentryVirtualAttributeCfgClient, ? extends SubschemaSubentryVirtualAttributeCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class SubschemaSubentryVirtualAttributeCfgServerImpl implements
    SubschemaSubentryVirtualAttributeCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends SubschemaSubentryVirtualAttributeCfg> impl;
    ...
    /** Private constructor. */
    private SubschemaSubentryVirtualAttributeCfgServerImpl(ServerManagedObject<? extends SubschemaSubentryVirtualAttributeCfg> impl) {
      this.impl = impl;
    ...
    /** {@inheritDoc} */
    public void addSubschemaSubentryChangeListener(
        ConfigurationChangeListener<SubschemaSubentryVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removeSubschemaSubentryChangeListener(
        ConfigurationChangeListener<SubschemaSubentryVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends SubschemaSubentryVirtualAttributeCfg> configurationClass() {
      return SubschemaSubentryVirtualAttributeCfg.class;
    }
