...
import org.forgerock.opendj.server.config.client.NullBackendCfgClient;
...
import org.forgerock.opendj.server.config.server.NullBackendCfg;
 ...
 */
public final class NullBackendCfgDefn extends ManagedObjectDefinition<NullBackendCfgClient, NullBackendCfg> {

  /** The singleton configuration definition instance. */
  private static final NullBackendCfgDefn INSTANCE = new NullBackendCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.backends.NullBackend");
   ...
   *
   * @return Returns the Null Backend configuration definition
   *         singleton.
   */
  public static NullBackendCfgDefn getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private NullBackendCfgDefn() {
    super("null-backend", LocalBackendCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public NullBackendCfgClient createClientConfiguration(
      ManagedObject<? extends NullBackendCfgClient> impl) {
    return new NullBackendCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public NullBackendCfg createServerConfiguration(
      ServerManagedObject<? extends NullBackendCfg> impl) {
    return new NullBackendCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<NullBackendCfg> getServerConfigurationClass() {
    return NullBackendCfg.class;
  }
   ...
   */
  private static class NullBackendCfgClientImpl implements
    NullBackendCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends NullBackendCfgClient> impl;



    /** Private constructor. */
    private NullBackendCfgClientImpl(
        ManagedObject<? extends NullBackendCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends NullBackendCfgClient, ? extends NullBackendCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class NullBackendCfgServerImpl implements
    NullBackendCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends NullBackendCfg> impl;
    ...
    /** Private constructor. */
    private NullBackendCfgServerImpl(ServerManagedObject<? extends NullBackendCfg> impl) {
      this.impl = impl;
    ...
    public void addNullChangeListener(
        ConfigurationChangeListener<NullBackendCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removeNullChangeListener(
        ConfigurationChangeListener<NullBackendCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends NullBackendCfg> configurationClass() {
      return NullBackendCfg.class;
    }
