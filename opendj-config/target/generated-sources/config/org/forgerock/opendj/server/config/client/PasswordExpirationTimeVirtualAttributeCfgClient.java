 ...
 */
public interface PasswordExpirationTimeVirtualAttributeCfgClient extends VirtualAttributeCfgClient {

  /**
   * Get the configuration definition associated with this Password Expiration Time Virtual Attribute.
   *
   * @return Returns the configuration definition associated with this Password Expiration Time Virtual Attribute.
   */
  ManagedObjectDefinition<? extends PasswordExpirationTimeVirtualAttributeCfgClient, ? extends PasswordExpirationTimeVirtualAttributeCfg> definition();
