...
public interface LDAPConnectionHandlerCfgClient extends ConnectionHandlerCfgClient {
   ...
   *           If the new value is invalid.
   */
  void setAllowLDAPV2(Boolean value) throws PropertyException;
   ...
   *           If the new value is invalid.
   */
  void setAllowStartTLS(Boolean value) throws PropertyException;
   ...
   *           If the new value is invalid.
   */
  void setSendRejectionNotice(Boolean value) throws PropertyException;
