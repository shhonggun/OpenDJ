...
import org.forgerock.opendj.server.config.client.NumSubordinatesVirtualAttributeCfgClient;
...
public final class NumSubordinatesVirtualAttributeCfgDefn extends ManagedObjectDefinition<NumSubordinatesVirtualAttributeCfgClient, NumSubordinatesVirtualAttributeCfg> {
  ...
  static {
      ...
      DefaultBehaviorProvider<AttributeType> provider = new DefinedDefaultBehaviorProvider<AttributeType>("numSubordinates");
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.NumSubordinatesVirtualAttributeProvider");
      builder.setDefaultBehaviorProvider(provider);
   ...
   *
   * @return Returns the Num Subordinates Virtual Attribute
  ...
  /** {@inheritDoc} */
  public NumSubordinatesVirtualAttributeCfgClient createClientConfiguration(
      ManagedObject<? extends NumSubordinatesVirtualAttributeCfgClient> impl) {
    return new NumSubordinatesVirtualAttributeCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public NumSubordinatesVirtualAttributeCfg createServerConfiguration(
      ServerManagedObject<? extends NumSubordinatesVirtualAttributeCfg> impl) {
    return new NumSubordinatesVirtualAttributeCfgServerImpl(impl);
  }
   ...
   * <p>
   * Indicates whether the Num Subordinates Virtual Attribute is
   * enabled for use.
   *
   ...
   */
  private static class NumSubordinatesVirtualAttributeCfgClientImpl implements
    ...
    /** Private constructor. */
    private NumSubordinatesVirtualAttributeCfgClientImpl(
        ManagedObject<? extends NumSubordinatesVirtualAttributeCfgClient> impl) {
      this.impl = impl;
    }
   ...
   */
  private static class NumSubordinatesVirtualAttributeCfgServerImpl implements
    ...
    /** Private constructor. */
    private NumSubordinatesVirtualAttributeCfgServerImpl(ServerManagedObject<? extends NumSubordinatesVirtualAttributeCfg> impl) {
      this.impl = impl;
    ...
    /** {@inheritDoc} */
    public void addNumSubordinatesChangeListener(
        ConfigurationChangeListener<NumSubordinatesVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removeNumSubordinatesChangeListener(
        ConfigurationChangeListener<NumSubordinatesVirtualAttributeCfg> listener) {
