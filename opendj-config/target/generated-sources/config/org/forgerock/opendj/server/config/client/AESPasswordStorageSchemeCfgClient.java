 ...
 */
public interface AESPasswordStorageSchemeCfgClient extends PasswordStorageSchemeCfgClient {

  /**
   * Get the configuration definition associated with this AES Password Storage Scheme.
   *
   * @return Returns the configuration definition associated with this AES Password Storage Scheme.
   */
  ManagedObjectDefinition<? extends AESPasswordStorageSchemeCfgClient, ? extends AESPasswordStorageSchemeCfg> definition();
