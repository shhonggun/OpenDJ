...
public final class GroupImplementationCfgDefn extends ManagedObjectDefinition<GroupImplementationCfgClient, GroupImplementationCfg> {
   ...
   *
   * @return Returns the Group Implementation configuration definition
   *         singleton.
   */
  ...
  /** {@inheritDoc} */
  public GroupImplementationCfgClient createClientConfiguration(
      ManagedObject<? extends GroupImplementationCfgClient> impl) {
  ...
  /** {@inheritDoc} */
  public GroupImplementationCfg createServerConfiguration(
      ServerManagedObject<? extends GroupImplementationCfg> impl) {
   ...
   */
  private static class GroupImplementationCfgClientImpl implements
    ...
    /** Private constructor. */
    private GroupImplementationCfgClientImpl(
        ManagedObject<? extends GroupImplementationCfgClient> impl) {
      this.impl = impl;
    }
   ...
   */
  private static class GroupImplementationCfgServerImpl implements
