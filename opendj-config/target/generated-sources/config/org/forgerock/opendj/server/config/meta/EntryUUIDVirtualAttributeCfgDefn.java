...
import org.forgerock.opendj.server.config.client.EntryUUIDVirtualAttributeCfgClient;
 ...
 * attribute.
 */
public final class EntryUUIDVirtualAttributeCfgDefn extends ManagedObjectDefinition<EntryUUIDVirtualAttributeCfgClient, EntryUUIDVirtualAttributeCfg> {

  /** The singleton configuration definition instance. */
  private static final EntryUUIDVirtualAttributeCfgDefn INSTANCE = new EntryUUIDVirtualAttributeCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<AttributeType> provider = new DefinedDefaultBehaviorProvider<AttributeType>("entryUUID");
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.EntryUUIDVirtualAttributeProvider");
      builder.setDefaultBehaviorProvider(provider);
   ...
   * singleton.
   *
   * @return Returns the Entry UUID Virtual Attribute configuration
   *         definition singleton.
   */
  public static EntryUUIDVirtualAttributeCfgDefn getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private EntryUUIDVirtualAttributeCfgDefn() {
    super("entry-uuid-virtual-attribute", VirtualAttributeCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public EntryUUIDVirtualAttributeCfgClient createClientConfiguration(
      ManagedObject<? extends EntryUUIDVirtualAttributeCfgClient> impl) {
    return new EntryUUIDVirtualAttributeCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public EntryUUIDVirtualAttributeCfg createServerConfiguration(
      ServerManagedObject<? extends EntryUUIDVirtualAttributeCfg> impl) {
    return new EntryUUIDVirtualAttributeCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<EntryUUIDVirtualAttributeCfg> getServerConfigurationClass() {
    return EntryUUIDVirtualAttributeCfg.class;
  }
   ...
   * <p>
   * Indicates whether the Entry UUID Virtual Attribute is enabled for
   * use.
   *
   ...
   */
  private static class EntryUUIDVirtualAttributeCfgClientImpl implements
    EntryUUIDVirtualAttributeCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends EntryUUIDVirtualAttributeCfgClient> impl;



    /** Private constructor. */
    private EntryUUIDVirtualAttributeCfgClientImpl(
        ManagedObject<? extends EntryUUIDVirtualAttributeCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends EntryUUIDVirtualAttributeCfgClient, ? extends EntryUUIDVirtualAttributeCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class EntryUUIDVirtualAttributeCfgServerImpl implements
    EntryUUIDVirtualAttributeCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends EntryUUIDVirtualAttributeCfg> impl;
    ...
    /** Private constructor. */
    private EntryUUIDVirtualAttributeCfgServerImpl(ServerManagedObject<? extends EntryUUIDVirtualAttributeCfg> impl) {
      this.impl = impl;
    ...
    public void addEntryUUIDChangeListener(
        ConfigurationChangeListener<EntryUUIDVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends EntryUUIDVirtualAttributeCfg> configurationClass() {
      return EntryUUIDVirtualAttributeCfg.class;
    }
