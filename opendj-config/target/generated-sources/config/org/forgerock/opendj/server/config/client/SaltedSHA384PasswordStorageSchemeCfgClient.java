 ...
 */
public interface SaltedSHA384PasswordStorageSchemeCfgClient extends PasswordStorageSchemeCfgClient {

  /**
   * Get the configuration definition associated with this Salted SHA384 Password Storage Scheme.
   *
   * @return Returns the configuration definition associated with this Salted SHA384 Password Storage Scheme.
   */
