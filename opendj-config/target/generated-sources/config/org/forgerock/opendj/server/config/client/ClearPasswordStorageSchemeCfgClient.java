 ...
 */
public interface ClearPasswordStorageSchemeCfgClient extends PasswordStorageSchemeCfgClient {

  /**
   * Get the configuration definition associated with this Clear Password Storage Scheme.
   *
   * @return Returns the configuration definition associated with this Clear Password Storage Scheme.
   */
  ManagedObjectDefinition<? extends ClearPasswordStorageSchemeCfgClient, ? extends ClearPasswordStorageSchemeCfg> definition();
