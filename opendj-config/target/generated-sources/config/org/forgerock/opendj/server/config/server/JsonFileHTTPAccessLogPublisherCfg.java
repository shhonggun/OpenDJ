...
public interface JsonFileHTTPAccessLogPublisherCfg extends HTTPAccessLogPublisherCfg {
   ...
   *
   * @return Returns the configuration class associated with this Json File HTTP Access Log Publisher.
   */
   ...
   *
   * @param listener
   *          The Json File HTTP Access Log Publisher configuration change listener.
   */
