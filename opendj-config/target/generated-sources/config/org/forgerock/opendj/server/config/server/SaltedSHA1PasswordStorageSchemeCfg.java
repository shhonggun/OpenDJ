...
public interface SaltedSHA1PasswordStorageSchemeCfg extends PasswordStorageSchemeCfg {
   ...
   *
   * @return Returns the configuration class associated with this Salted SHA1 Password Storage Scheme.
   */
   ...
   *
   * @param listener
   *          The Salted SHA1 Password Storage Scheme configuration change listener.
   */
  void addSaltedSHA1ChangeListener(ConfigurationChangeListener<SaltedSHA1PasswordStorageSchemeCfg> listener);
   ...
   *          The Salted SHA1 Password Storage Scheme configuration change listener.
   */
  void removeSaltedSHA1ChangeListener(ConfigurationChangeListener<SaltedSHA1PasswordStorageSchemeCfg> listener);
