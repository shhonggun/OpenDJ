 ...
 * to the file system.
 */
public interface FileBasedHTTPAccessLogPublisherCfg extends HTTPAccessLogPublisherCfg {

  /**
   * Gets the configuration class associated with this File Based HTTP Access Log Publisher.
   *
   * @return Returns the configuration class associated with this File Based HTTP Access Log Publisher.
   */
  Class<? extends FileBasedHTTPAccessLogPublisherCfg> configurationClass();
   ...
   *
   * @param listener
   *          The File Based HTTP Access Log Publisher configuration change listener.
   */
  void addFileBasedHTTPAccessChangeListener(ConfigurationChangeListener<FileBasedHTTPAccessLogPublisherCfg> listener);
   ...
   *          The File Based HTTP Access Log Publisher configuration change listener.
   */
  void removeFileBasedHTTPAccessChangeListener(ConfigurationChangeListener<FileBasedHTTPAccessLogPublisherCfg> listener);
