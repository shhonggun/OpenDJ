...
import org.forgerock.opendj.server.config.client.HasSubordinatesVirtualAttributeCfgClient;
 ...
 * <p>
 * The Has Subordinates Virtual Attribute generates a virtual
 * attribute that indicates whether the entry has any subordinate
 * entries.
 */
public final class HasSubordinatesVirtualAttributeCfgDefn extends ManagedObjectDefinition<HasSubordinatesVirtualAttributeCfgClient, HasSubordinatesVirtualAttributeCfg> {

  /** The singleton configuration definition instance. */
  private static final HasSubordinatesVirtualAttributeCfgDefn INSTANCE = new HasSubordinatesVirtualAttributeCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<AttributeType> provider = new DefinedDefaultBehaviorProvider<AttributeType>("hasSubordinates");
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.HasSubordinatesVirtualAttributeProvider");
      builder.setDefaultBehaviorProvider(provider);
   ...
   *
   * @return Returns the Has Subordinates Virtual Attribute
   *         configuration definition singleton.
   */
  public static HasSubordinatesVirtualAttributeCfgDefn getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private HasSubordinatesVirtualAttributeCfgDefn() {
    super("has-subordinates-virtual-attribute", VirtualAttributeCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public HasSubordinatesVirtualAttributeCfgClient createClientConfiguration(
      ManagedObject<? extends HasSubordinatesVirtualAttributeCfgClient> impl) {
    return new HasSubordinatesVirtualAttributeCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public HasSubordinatesVirtualAttributeCfg createServerConfiguration(
      ServerManagedObject<? extends HasSubordinatesVirtualAttributeCfg> impl) {
    return new HasSubordinatesVirtualAttributeCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<HasSubordinatesVirtualAttributeCfg> getServerConfigurationClass() {
    return HasSubordinatesVirtualAttributeCfg.class;
  }
   ...
   * <p>
   * Indicates whether the Has Subordinates Virtual Attribute is
   * enabled for use.
   *
   ...
   */
  private static class HasSubordinatesVirtualAttributeCfgClientImpl implements
    HasSubordinatesVirtualAttributeCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends HasSubordinatesVirtualAttributeCfgClient> impl;



    /** Private constructor. */
    private HasSubordinatesVirtualAttributeCfgClientImpl(
        ManagedObject<? extends HasSubordinatesVirtualAttributeCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends HasSubordinatesVirtualAttributeCfgClient, ? extends HasSubordinatesVirtualAttributeCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class HasSubordinatesVirtualAttributeCfgServerImpl implements
    HasSubordinatesVirtualAttributeCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends HasSubordinatesVirtualAttributeCfg> impl;
    ...
    /** Private constructor. */
    private HasSubordinatesVirtualAttributeCfgServerImpl(ServerManagedObject<? extends HasSubordinatesVirtualAttributeCfg> impl) {
      this.impl = impl;
    ...
    /** {@inheritDoc} */
    public void addHasSubordinatesChangeListener(
        ConfigurationChangeListener<HasSubordinatesVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removeHasSubordinatesChangeListener(
        ConfigurationChangeListener<HasSubordinatesVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends HasSubordinatesVirtualAttributeCfg> configurationClass() {
      return HasSubordinatesVirtualAttributeCfg.class;
    }
