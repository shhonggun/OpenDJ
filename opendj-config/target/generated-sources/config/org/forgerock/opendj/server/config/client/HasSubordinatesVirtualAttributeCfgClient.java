 ...
 * entries.
 */
public interface HasSubordinatesVirtualAttributeCfgClient extends VirtualAttributeCfgClient {

  /**
   * Get the configuration definition associated with this Has Subordinates Virtual Attribute.
   *
   * @return Returns the configuration definition associated with this Has Subordinates Virtual Attribute.
   */
