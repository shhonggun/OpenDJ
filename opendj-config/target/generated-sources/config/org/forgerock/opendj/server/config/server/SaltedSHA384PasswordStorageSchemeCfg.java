...
public interface SaltedSHA384PasswordStorageSchemeCfg extends PasswordStorageSchemeCfg {
   ...
   *
   * @return Returns the configuration class associated with this Salted SHA384 Password Storage Scheme.
   */
   ...
   *
   * @param listener
   *          The Salted SHA384 Password Storage Scheme configuration change listener.
   */
  void addSaltedSHA384ChangeListener(ConfigurationChangeListener<SaltedSHA384PasswordStorageSchemeCfg> listener);
   ...
   *          The Salted SHA384 Password Storage Scheme configuration change listener.
   */
  void removeSaltedSHA384ChangeListener(ConfigurationChangeListener<SaltedSHA384PasswordStorageSchemeCfg> listener);
