...
import org.forgerock.opendj.server.config.client.ChangeNumberControlPluginCfgClient;
 ...
 */
public final class ChangeNumberControlPluginCfgDefn extends ManagedObjectDefinition<ChangeNumberControlPluginCfgClient, ChangeNumberControlPluginCfg> {

  /** The singleton configuration definition instance. */
  private static final ChangeNumberControlPluginCfgDefn INSTANCE = new ChangeNumberControlPluginCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.plugins.ChangeNumberControlPlugin");
  ...
  static {
      ...
      DefaultBehaviorProvider<PluginType> provider = new DefinedDefaultBehaviorProvider<PluginType>("postOperationAdd", "postOperationDelete", "postOperationModify", "postOperationModifyDN");
      builder.setDefaultBehaviorProvider(provider);
   ...
   * singleton.
   *
   * @return Returns the Change Number Control Plugin configuration
   *         definition singleton.
   */
  public static ChangeNumberControlPluginCfgDefn getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private ChangeNumberControlPluginCfgDefn() {
    super("change-number-control-plugin", PluginCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public ChangeNumberControlPluginCfgClient createClientConfiguration(
      ManagedObject<? extends ChangeNumberControlPluginCfgClient> impl) {
    return new ChangeNumberControlPluginCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public ChangeNumberControlPluginCfg createServerConfiguration(
      ServerManagedObject<? extends ChangeNumberControlPluginCfg> impl) {
    return new ChangeNumberControlPluginCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<ChangeNumberControlPluginCfg> getServerConfigurationClass() {
    return ChangeNumberControlPluginCfg.class;
  }
   ...
   */
  private static class ChangeNumberControlPluginCfgClientImpl implements
    ChangeNumberControlPluginCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends ChangeNumberControlPluginCfgClient> impl;



    /** Private constructor. */
    private ChangeNumberControlPluginCfgClientImpl(
        ManagedObject<? extends ChangeNumberControlPluginCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends ChangeNumberControlPluginCfgClient, ? extends ChangeNumberControlPluginCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class ChangeNumberControlPluginCfgServerImpl implements
    ChangeNumberControlPluginCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends ChangeNumberControlPluginCfg> impl;
    ...
    /** Private constructor. */
    private ChangeNumberControlPluginCfgServerImpl(ServerManagedObject<? extends ChangeNumberControlPluginCfg> impl) {
      this.impl = impl;
    ...
    /** {@inheritDoc} */
    public void addChangeNumberControlChangeListener(
        ConfigurationChangeListener<ChangeNumberControlPluginCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removeChangeNumberControlChangeListener(
        ConfigurationChangeListener<ChangeNumberControlPluginCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends ChangeNumberControlPluginCfg> configurationClass() {
      return ChangeNumberControlPluginCfg.class;
    }
