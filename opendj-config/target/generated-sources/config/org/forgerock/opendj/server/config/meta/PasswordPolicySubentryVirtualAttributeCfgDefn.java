...
import org.forgerock.opendj.server.config.client.PasswordPolicySubentryVirtualAttributeCfgClient;
...
import org.forgerock.opendj.server.config.server.PasswordPolicySubentryVirtualAttributeCfg;
 ...
 * the entry.
 */
public final class PasswordPolicySubentryVirtualAttributeCfgDefn extends ManagedObjectDefinition<PasswordPolicySubentryVirtualAttributeCfgClient, PasswordPolicySubentryVirtualAttributeCfg> {

  /** The singleton configuration definition instance. */
  private static final PasswordPolicySubentryVirtualAttributeCfgDefn INSTANCE = new PasswordPolicySubentryVirtualAttributeCfgDefn();
  ...
  static {
      ...
      DefaultBehaviorProvider<AttributeType> provider = new DefinedDefaultBehaviorProvider<AttributeType>("pwdPolicySubentry");
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.PasswordPolicySubentryVirtualAttributeProvider");
      builder.setDefaultBehaviorProvider(provider);
   ...
   *
   * @return Returns the Password Policy Subentry Virtual Attribute
   *         configuration definition singleton.
   */
  public static PasswordPolicySubentryVirtualAttributeCfgDefn getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private PasswordPolicySubentryVirtualAttributeCfgDefn() {
    super("password-policy-subentry-virtual-attribute", VirtualAttributeCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public PasswordPolicySubentryVirtualAttributeCfgClient createClientConfiguration(
      ManagedObject<? extends PasswordPolicySubentryVirtualAttributeCfgClient> impl) {
    return new PasswordPolicySubentryVirtualAttributeCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public PasswordPolicySubentryVirtualAttributeCfg createServerConfiguration(
      ServerManagedObject<? extends PasswordPolicySubentryVirtualAttributeCfg> impl) {
    return new PasswordPolicySubentryVirtualAttributeCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<PasswordPolicySubentryVirtualAttributeCfg> getServerConfigurationClass() {
    return PasswordPolicySubentryVirtualAttributeCfg.class;
  }
   ...
   * <p>
   * Indicates whether the Password Policy Subentry Virtual Attribute
   * is enabled for use.
   *
   ...
   */
  private static class PasswordPolicySubentryVirtualAttributeCfgClientImpl implements
    PasswordPolicySubentryVirtualAttributeCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends PasswordPolicySubentryVirtualAttributeCfgClient> impl;



    /** Private constructor. */
    private PasswordPolicySubentryVirtualAttributeCfgClientImpl(
        ManagedObject<? extends PasswordPolicySubentryVirtualAttributeCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends PasswordPolicySubentryVirtualAttributeCfgClient, ? extends PasswordPolicySubentryVirtualAttributeCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class PasswordPolicySubentryVirtualAttributeCfgServerImpl implements
    PasswordPolicySubentryVirtualAttributeCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends PasswordPolicySubentryVirtualAttributeCfg> impl;
    ...
    /** Private constructor. */
    private PasswordPolicySubentryVirtualAttributeCfgServerImpl(ServerManagedObject<? extends PasswordPolicySubentryVirtualAttributeCfg> impl) {
      this.impl = impl;
    ...
    /** {@inheritDoc} */
    public void addPasswordPolicySubentryChangeListener(
        ConfigurationChangeListener<PasswordPolicySubentryVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removePasswordPolicySubentryChangeListener(
        ConfigurationChangeListener<PasswordPolicySubentryVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public Class<? extends PasswordPolicySubentryVirtualAttributeCfg> configurationClass() {
      return PasswordPolicySubentryVirtualAttributeCfg.class;
    }
