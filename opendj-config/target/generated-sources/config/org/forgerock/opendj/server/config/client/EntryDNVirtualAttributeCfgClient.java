 ...
 * the entry's DN.
 */
public interface EntryDNVirtualAttributeCfgClient extends VirtualAttributeCfgClient {

  /**
   * Get the configuration definition associated with this Entry DN Virtual Attribute.
   *
   * @return Returns the configuration definition associated with this Entry DN Virtual Attribute.
   */
  ManagedObjectDefinition<? extends EntryDNVirtualAttributeCfgClient, ? extends EntryDNVirtualAttributeCfg> definition();
