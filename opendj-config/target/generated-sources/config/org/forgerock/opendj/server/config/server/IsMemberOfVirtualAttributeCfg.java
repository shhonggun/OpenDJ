...
public interface IsMemberOfVirtualAttributeCfg extends VirtualAttributeCfg {
   ...
   *
   * @return Returns the configuration class associated with this Is Member Of Virtual Attribute.
   */
   ...
   *
   * @param listener
   *          The Is Member Of Virtual Attribute configuration change listener.
   */
  void addIsMemberOfChangeListener(ConfigurationChangeListener<IsMemberOfVirtualAttributeCfg> listener);
   ...
   *          The Is Member Of Virtual Attribute configuration change listener.
   */
  void removeIsMemberOfChangeListener(ConfigurationChangeListener<IsMemberOfVirtualAttributeCfg> listener);
