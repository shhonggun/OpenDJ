...
public interface SubschemaSubentryVirtualAttributeCfg extends VirtualAttributeCfg {
   ...
   *
   * @return Returns the configuration class associated with this Subschema Subentry Virtual Attribute.
   */
   ...
   *
   * @param listener
   *          The Subschema Subentry Virtual Attribute configuration change listener.
   */
   ...
   *          The Subschema Subentry Virtual Attribute configuration change listener.
   */
  void removeSubschemaSubentryChangeListener(ConfigurationChangeListener<SubschemaSubentryVirtualAttributeCfg> listener);
