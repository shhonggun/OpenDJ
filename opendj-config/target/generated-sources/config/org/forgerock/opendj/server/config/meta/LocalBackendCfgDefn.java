 ...
 */
public final class LocalBackendCfgDefn extends ManagedObjectDefinition<LocalBackendCfgClient, LocalBackendCfg> {

  /** The singleton configuration definition instance. */
  private static final LocalBackendCfgDefn INSTANCE = new LocalBackendCfgDefn();
   ...
   *
   * @return Returns the Local Backend configuration definition
   *         singleton.
   */
  public static LocalBackendCfgDefn getInstance() {
    return INSTANCE;
  }
   ...
   * Private constructor.
   */
  private LocalBackendCfgDefn() {
    super("local-backend", BackendCfgDefn.getInstance());
  }



  /** {@inheritDoc} */
  public LocalBackendCfgClient createClientConfiguration(
      ManagedObject<? extends LocalBackendCfgClient> impl) {
    return new LocalBackendCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public LocalBackendCfg createServerConfiguration(
      ServerManagedObject<? extends LocalBackendCfg> impl) {
    return new LocalBackendCfgServerImpl(impl);
  }



  /** {@inheritDoc} */
  public Class<LocalBackendCfg> getServerConfigurationClass() {
    return LocalBackendCfg.class;
  }
   ...
   */
  private static class LocalBackendCfgClientImpl implements
    LocalBackendCfgClient {

    /** Private implementation. */
    private ManagedObject<? extends LocalBackendCfgClient> impl;



    /** Private constructor. */
    private LocalBackendCfgClientImpl(
        ManagedObject<? extends LocalBackendCfgClient> impl) {
      this.impl = impl;
    }
    ...
    /** {@inheritDoc} */
    public ManagedObjectDefinition<? extends LocalBackendCfgClient, ? extends LocalBackendCfg> definition() {
      return INSTANCE;
    }
   ...
   */
  private static class LocalBackendCfgServerImpl implements
    LocalBackendCfg {

    /** Private implementation. */
    private ServerManagedObject<? extends LocalBackendCfg> impl;
    ...
    /** Private constructor. */
    private LocalBackendCfgServerImpl(ServerManagedObject<? extends LocalBackendCfg> impl) {
      this.impl = impl;
