 ...
 * <p>
 * The Password Expiration Time Virtual Attribute generates a virtual
 * attribute which shows the password expiration date.
 */
public final class PasswordExpirationTimeVirtualAttributeCfgDefn extends ManagedObjectDefinition<PasswordExpirationTimeVirtualAttributeCfgClient, PasswordExpirationTimeVirtualAttributeCfg> {
  ...
  static {
      ...
      DefaultBehaviorProvider<AttributeType> provider = new DefinedDefaultBehaviorProvider<AttributeType>("ds-pwp-password-expiration-time");
  ...
  static {
      ...
      DefaultBehaviorProvider<String> provider = new DefinedDefaultBehaviorProvider<String>("org.opends.server.extensions.PasswordExpirationTimeVirtualAttributeProvider");
      builder.setDefaultBehaviorProvider(provider);
   ...
   *
   * @return Returns the Password Expiration Time Virtual Attribute
  ...
  /** {@inheritDoc} */
  public PasswordExpirationTimeVirtualAttributeCfgClient createClientConfiguration(
      ManagedObject<? extends PasswordExpirationTimeVirtualAttributeCfgClient> impl) {
    return new PasswordExpirationTimeVirtualAttributeCfgClientImpl(impl);
  }



  /** {@inheritDoc} */
  public PasswordExpirationTimeVirtualAttributeCfg createServerConfiguration(
      ServerManagedObject<? extends PasswordExpirationTimeVirtualAttributeCfg> impl) {
    return new PasswordExpirationTimeVirtualAttributeCfgServerImpl(impl);
  }
   ...
   * <p>
   * Indicates whether the Password Expiration Time Virtual Attribute
   * is enabled for use.
   *
   ...
   */
  private static class PasswordExpirationTimeVirtualAttributeCfgClientImpl implements
    ...
    /** Private constructor. */
    private PasswordExpirationTimeVirtualAttributeCfgClientImpl(
        ManagedObject<? extends PasswordExpirationTimeVirtualAttributeCfgClient> impl) {
      this.impl = impl;
    }
   ...
   */
  private static class PasswordExpirationTimeVirtualAttributeCfgServerImpl implements
    ...
    /** Private constructor. */
    private PasswordExpirationTimeVirtualAttributeCfgServerImpl(ServerManagedObject<? extends PasswordExpirationTimeVirtualAttributeCfg> impl) {
      this.impl = impl;
    ...
    /** {@inheritDoc} */
    public void addPasswordExpirationTimeChangeListener(
        ConfigurationChangeListener<PasswordExpirationTimeVirtualAttributeCfg> listener) {
    ...
    /** {@inheritDoc} */
    public void removePasswordExpirationTimeChangeListener(
        ConfigurationChangeListener<PasswordExpirationTimeVirtualAttributeCfg> listener) {
