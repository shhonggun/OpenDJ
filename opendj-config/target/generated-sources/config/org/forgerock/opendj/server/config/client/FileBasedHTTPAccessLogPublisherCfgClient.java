...
public interface FileBasedHTTPAccessLogPublisherCfgClient extends HTTPAccessLogPublisherCfgClient {
   ...
   *
   * @return Returns the configuration definition associated with this File Based HTTP Access Log Publisher.
   */
   ...
   *           If the new value is invalid.
   */
  void setLogFormat(String value) throws PropertyException;
